 ...
 * Example: php bump-version.php 1.1.9
 * 
...
if ($argc < 2) {
    ...
    echo "Example: php bump-version.php 1.1.9\n";
    exit(1);
}
...
$files = [
    ...
    [
        'file' => findFile($rootDir, 'force-reinstall.php'),
    ...
    [
        'file' => findFile($rootDir, 'force-reinstall.php'),
        'pattern' => "/(const FORCE_REINSTALL_VERSION = ')\d+\.\d+\.\d+('\;)/",
